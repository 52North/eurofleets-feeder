...
public interface ObservedProperties {
    ...
    ObservedProperty WIND_MEAN = new ObservedProperty("wind_mean", "Wind mean", "http://vocab.nerc.ac.uk/collection/P01/current/EWSTEN01/");
    ...
    ObservedProperty WIND_GUST = new ObservedProperty("wind_gust", "Wind gust", "http://vocab.nerc.ac.uk/collection/P01/current/EGTSZZ01/");
    ...
    Map<ObservedProperty, UnitOfMeasurement> UNITS = ImmutableMap.<ObservedProperty, UnitOfMeasurement>builder()
                                                             ...
                                                             .put(ObservedProperties.WIND_MEAN, Units.METRES_PER_SECOND)
                                                             .put(ObservedProperties.SPEED_OVER_GROUND, Units.KNOTS)
                                                             .put(ObservedProperties.COURSE_OVER_GROUND, Units.DEGREES)
                                                             .put(ObservedProperties.WIND_GUST, Units.METRES_PER_SECOND)
