...
class ThermosalinityDatagramTest {
    ...
    public void testParsePsd() throws DatagramParseException {
        final ThermosalinityDatagram parse = new ThermosalinityDatagram(" $PSDGTSS,20160524,001332,3.198552,51.335977,20.4955,35.7082,25.171204,49.298992,1.150183,9999.9004");
    ...
    public void testParseBel() throws DatagramParseException {
        final ThermosalinityDatagram parse = new ThermosalinityDatagram("$BELTSS,200311,044500,3.198552,51.335977,28.885399,8.032499,,30.746801,22.471699");
