...
class MeteorologyDatagramTest {
    ...
    public void testParsePsd() throws DatagramParseException {
        final MeteorologyDatagram parse = new MeteorologyDatagram("$PSDGMET,20160505,003250,3.198552,51.335977,5.30,5.38,16.77,103.20,0.00,1014.66,17.4");
        ...
        assertThat(parse.getValue(ObservedProperties.WIND_SPEED), is(5.3));
    ...
    public void testParseBel() throws DatagramParseException {
        ...
        assertThat(parse.getValue(ObservedProperties.WIND_SPEED), is(10.8));
    ...
    public void testParsePsdOld() throws DatagramParseException {
        final MeteorologyDatagram parse = new MeteorologyDatagram("$PSDGMET,190220,115715,3.198552,51.335977,1.81411,140,13.23305,61.39138,283.5505,1038.438");
        assertThat(parse.getGeometry(), is(geometryFactory
                                                   .createPoint(new CoordinateXY(3.198552, 51.335977))));

        assertThat(parse.getDateTime(), is(OffsetDateTime.of(2020, 2, 19, 11, 57, 15, 0, ZoneOffset.UTC)));
        assertThat(parse.getValue(ObservedProperties.WIND_SPEED), is(1.81411));
    ...
    @Test
    public void testParseNew() throws DatagramParseException {
        MeteorologyDatagram datagram = new MeteorologyDatagram("$GDCMET,20200416,211515,2.1840000,41.3755000,2.76220,0,15.77475,89.81701,0,1019.000");
        assertThat(datagram.getGeometry(), is(geometryFactory.createPoint(new CoordinateXY(2.184, 41.3755))));
    }
}